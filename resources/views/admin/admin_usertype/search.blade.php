    ...
    @if($search || !empty($filter['enable']))
        <div class="mt-3 flex items-center gap-2">
            ...
            @if(!empty($filter['enable']))
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $filter['enable'] == '1' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
