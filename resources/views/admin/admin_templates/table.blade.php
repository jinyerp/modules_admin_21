<article
    class="mt-8 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-800">
                <tr>
                    ...
                    <th scope="col"
                        ...
                        <button wire:click="sortBy('id')" class="group inline-flex items-center">
                            ...
                            @if ($sortField === 'id')
                                ...
                                @endif
                            @else
                                <svg class="ml-1 h-4 w-4 text-gray-300 group-hover:text-gray-400" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                    ...
                    {{-- Name --}}
                    <th scope="col"
                        class="min-w-48 px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">
                    ...
                    <th scope="col"
                        class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">
                        <button wire:click="sortBy('path')" class="group inline-flex items-center">
                            Path
                            @if ($sortField === 'path')
                                @if ($sortDirection === 'asc')
                                    <svg class="ml-1 h-4 w-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                @forelse($rows as $item)
                    <tr
                        class="hover:bg-gray-50 dark:hover:bg-gray-800/50 {{ in_array($item->id, $selected) ? 'bg-blue-50 dark:bg-blue-900/20' : '' }}">
                        {{-- Checkbox --}}
                        ...
                        <td class="py-4 px-3 text-sm font-medium whitespace-nowrap text-gray-900 dark:text-white">
                            <a href="/admin2/templates/{{ $item->id }}"
                        ...
                        <td class="py-4 pr-4 pl-3 text-right text-sm font-medium whitespace-nowrap sm:pr-3">
                            <a href="/admin2/templates/{{ $item->id }}/edit"
