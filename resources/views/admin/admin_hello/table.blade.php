        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                    <a href="{{ route('admin.hello.show', $item->id) }}" class="text-indigo-600 hover:text-indigo-900">
                        {{ $item->name }}
                    </a>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <a href="{{ route('admin.hello.show', $item->id) }}" class="text-gray-600 hover:text-gray-900 mr-2">
                    ...
                    <a href="{{ route('admin.hello.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">
                        <svg class="inline-block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                    </a>
                    <button wire:click="deleteConfirm({{ $item->id }})" class="text-red-600 hover:text-red-900">
                        <svg class="inline-block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
