            ...
            <div class="relative flex h-full w-screen max-w-md flex-col divide-y divide-gray-200 bg-white shadow-xl">
                ...
                <div class="h-0 flex-1 overflow-y-auto">
                    <div class="bg-indigo-700 px-4 py-6 sm:px-6">
                        <div class="flex items-center justify-between">
                            <h2 class="text-base font-semibold text-white">생성 페이지 설정</h2>
                        ...
                        <div class="mt-1">
                            <p class="text-sm text-indigo-300">생성 페이지 표시 옵션과 기능을 설정할 수 있습니다.</p>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3 space-y-3">
                                        <div class="flex items-center">
                                            <input id="create-enable-continue-create" 
                                                   type="checkbox" 
                                                   wire:model.live="enableContinueCreate"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            <label for="create-enable-continue-create" class="ml-3 text-sm text-gray-700">계속 생성 기능</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="create-enable-list-button" 
                                                   type="checkbox" 
                                                   wire:model.live="enableListButton"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            <label for="create-enable-list-button" class="ml-3 text-sm text-gray-700">목록 버튼 표시</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="create-enable-parent-navigation" 
                                                   type="checkbox" 
                                                   wire:model.live="enableParentNavigation"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            <label for="create-enable-parent-navigation" class="ml-3 text-sm text-gray-700">상위 탐색 표시</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="create-enable-hierarchy" 
                                                   type="checkbox" 
                                                   wire:model.live="enableHierarchy"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            <label for="create-enable-hierarchy" class="ml-3 text-sm text-gray-700">계층 구조 활성화</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="flex shrink-0 justify-end px-4 py-4">
                    ...
                    <button type="button" 
                            ...
                            class="ml-3 inline-flex justify-center rounded-md bg-indigo-600 px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
