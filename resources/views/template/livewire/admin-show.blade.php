    ...
    @else
        <div class="p-6 bg-red-50 border border-red-200 rounded-lg">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-red-800">상세보기 설정 오류</h3>
                    <p class="text-sm text-red-600 mt-1">
                        JSON 설정 파일에서 'show.showPath' 값이 누락되었거나 비어있습니다.
                    </p>
                    <p class="text-xs text-red-500 mt-2">
                        Error: Missing or empty 'show.showPath' configuration in JSON settings file.
                    </p>
                </div>
            </div>
        </div>
