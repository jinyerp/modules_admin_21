 ...
 * @package Jiny\Admin2
 */
class AdminTestDelete extends Controller
{
    private $jsonData;
    ...
    {
        // 데이터베이스에서 데이터 조회
        $tableName = $this->jsonData['table']['name'] ?? 'admin_tests';
        ...
        $viewPath = $this->jsonData['template']['delete'] ?? 
                    'jiny-admin2::admin.admin_test.delete';
    ...
    private function logDeletion($data)
    {
        ...
        Log::channel($channel)->$level('Test deleted', $logData);
    }
