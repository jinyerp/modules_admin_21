...
class VonageSmsService
{
     ...
     * 제공업체 정보 로드
     */
    private function loadProvider($providerId)
    {
        ...
        if ($provider) {
            ...
            $this->fromNumber = $provider->from_number;
        }
    }
    ...
    public function sendSms($toNumber, $message, $from = null)
    {
        try {
            ...
            // 한국 번호 포맷 정리 (010-1234-5678 -> 821012345678)
            ...
            $response = Http::asForm()->post($this->baseUrl . '/sms/json', [
                ...
                'from' => $fromNumber,
                'text' => $message,
                'type' => 'unicode' // 한글 지원을 위해 unicode 타입 사용
            ]);
